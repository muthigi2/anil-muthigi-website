const content = `Teaching Machines to Verify Cheques: My Journey with Siamese Networks
...
That simple reframing let us build a system that was scalable, accurate, and practical. And it set me on the path of exploring deep learning more seriously.`;
