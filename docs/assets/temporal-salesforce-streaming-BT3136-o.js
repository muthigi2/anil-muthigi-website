const e=`Temporal is an open source workflow orchestration platform that lets you write durable, long-running workflows in code.
...
Key takeaway: Temporal's 'code as state machine' model beats cron+queues for complex, stateful tasks.`;export{e as default};
